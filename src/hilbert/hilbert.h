...
template <int dim>
struct Point{int v[dim]; int &operator[](int i) {return v[i];}};
...
static Point<2> hilbert_getPos2d(int idx, int order);
static Point<3> hilbert_getPos3d(int idx, int order);
